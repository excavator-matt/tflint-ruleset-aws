...
There are 700+ rules available, see the [Rules documentation page](docs/rules/README.md) for a complete list. Note that not all of them are enabled by default (especially around [Best Practices](docs/rules/README.md#best-practicesnaming-conventions)).
